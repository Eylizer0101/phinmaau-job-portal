...
const EmployerLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={layoutVars}>
        ...
        >
          ...
          >
            <div className="p-6 sm:p-7">
              ...
              >
                You’ll be signed out of your account. You can log in again anytime.
              </p>
      ...
      {/* Mobile Drawer */}
      <aside
        id="employer-mobile-drawer" // ✅ QA: real target for aria-controls
        ref={drawerRef}
        className={[
      ...
      {/* ✅ Verification Required Modal (Simple English, QA-improved) */}
      {showVerifyModal && (
        <div
          className={[
          ...
          role="presentation"
          onMouseDown={(e) => {
            // ✅ close only when clicking the backdrop itself (not inside dialog)
